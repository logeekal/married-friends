...
/** The template assigned to the node */
export type Template_Fullwidth1 = ContentTemplate & {
  __typename?: 'Template_Fullwidth1';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
export type Template_Fullwidth2 = ContentTemplate & {
  __typename?: 'Template_Fullwidth2';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
export type Template_LeftSidebar = ContentTemplate & {
  __typename?: 'Template_LeftSidebar';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};
...
/** The template assigned to the node */
export type Template_NoFeaturedImage = ContentTemplate & {
  __typename?: 'Template_NoFeaturedImage';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};
